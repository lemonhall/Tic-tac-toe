...
> **说明**：训练步数指的是 Agent 执行动作的总次数，不是游戏回合数。
> 一局游戏通常需要 3-9 步，所以 5000 步 ≈ 600-1500 局游戏。

| 训练步数 | 约等于回合数 | 训练时间 | 预期胜率 | 说明 |
|---------|------------|---------|---------|------|
| 1,000 | ~100-300 | ~30秒 | 20-30% | 初步学习 |
| 5,000 | ~600-1500 | ~2分钟 | 40-50% | 基本策略 |
| 10,000 | ~1200-3000 | ~5分钟 | 50-60% | 较好策略 |
| 20,000 | ~2500-6000 | ~10分钟 | 60-70% | 优秀策略 |
| 50,000+ | ~6000-15000 | ~30分钟 | 70-80% | 接近最优 |
